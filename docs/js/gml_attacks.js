...
window.GML_ATTACKS = [
 ...
 },
 {
  ...
  "boxSetup": "if (!instance_exists(obj_moveheart) && !instance_exists(obj_heart))\n                    scr_moveheart();\n                \n                if (!instance_exists(obj_growtangle))\n                    instance_create(__view_get(e__VW.XView, 0) + 320, __view_get(e__VW.YView, 0) + 170, obj_growtangle);\n                \n                if (difficulty == 1 && rr == 0)\n                    obj_growtangle.target_angle += 45;",
  "turnTimer": 210,
  "variantOf": "Tornado",
  "alsoChoices": [
   null,
 ...
 },
 {
  ...
  "setup": "global.monsterattackname[myself] = \"Tornado\";\n                dc = scr_bulletspawner(x, y, obj_dbulletcontroller);\n                dc.type = 8;\n                dc.difficulty = difficulty;",
  "source": "gml_Object_obj_berdlyb2_enemy_Step_0.gml",
  "boxSetup": "if (!i_ex(obj_moveheart) && !i_ex(obj_heart))\n                scr_moveheart();\n            \n            if (!i_ex(obj_growtangle))\n                instance_create(__view_get(e__VW.XView, 0) + 320, __view_get(e__VW.YView, 0) + 170, obj_growtangle);\n            \n            if (difficulty == 1 && chosenattack == 0)\n                obj_growtangle.target_angle += 45;",
  "turnSetup": "scr_turntimer(260);",
  "turnTimer": 200,
  "variantOf": "Tornado",
  "alsoChoices": [
   null,
...
window.GML_ATTACKS_TURNSETUP = {
 ...
 "gerson": "scr_turntimer(999);",
 "jevil": "global.turntimer = 240;",
 "pink": "scr_turntimer(300);",
