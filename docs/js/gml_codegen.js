...
(function (global) {
  ...
  const BUILTIN_CONSTS = new Set([
    ...
    // event_perform codes. Unlisted, ev_draw read as an instance variable and
    // event_perform(ev_draw, ...) became event_perform(0, ...) — which is
    // ev_create, so the call re-ran the target's Create event every frame.
    'ev_create', 'ev_destroy', 'ev_alarm', 'ev_step', 'ev_collision',
    'ev_keyboard', 'ev_mouse', 'ev_other', 'ev_draw', 'ev_keypress',
    'ev_keyrelease', 'ev_trigger', 'ev_cleanup', 'ev_gesture', 'ev_pre_create',
    'ev_step_normal', 'ev_step_begin', 'ev_step_end',
    'ev_draw_normal', 'ev_gui', 'ev_resize', 'ev_draw_begin', 'ev_draw_end',
    'ev_gui_begin', 'ev_gui_end', 'ev_pre_draw', 'ev_post_draw',
    'ev_outside', 'ev_boundary', 'ev_game_start', 'ev_game_end',
    'ev_room_start', 'ev_room_end', 'ev_no_more_lives', 'ev_animation_end',
    'ev_end_of_path', 'ev_no_more_health', 'ev_close_button',
    ...
    'ev_alarm0', 'ev_alarm1', 'ev_alarm2', 'ev_alarm3', 'ev_alarm4', 'ev_alarm5',
    'ev_alarm6', 'ev_alarm7', 'ev_alarm8', 'ev_alarm9', 'ev_alarm10', 'ev_alarm11',
