...
const CHARS = {
  ...
  spamton: {
    ...
    spells: [
      { id: 'sneo_heart', name: 'Heart Attack', tp: 40, dmg: 30, dur: 500, kind: 'attack',
        text: 'SPAMTON NEO swings his [[HEART]]!' },
      { id: 'sneo_mail', name: 'Spam Mail', tp: 48, dmg: 32, dur: 480, kind: 'attack',
        text: 'SPAMTON NEO delivers SPAM MAIL!' },
      { id: 'sneo_words', name: 'Word Bullets', tp: 58, dmg: 34, dur: 480, kind: 'attack',
        text: 'SPAMTON NEO spits WORD BULLETS!' },
    ],
    ult: { id: 'sneo_bigshot', name: 'BIG SHOT', tp: 100, dmg: 50, dur: 620, kind: 'attack',
