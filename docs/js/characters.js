...
const CHARS = {
  ...
  gerson: {
    ...
    fight: { id: 'gerson_spears', name: 'Spear Volley', dmg: 38, dur: 300,
             text: 'GREEN SOUL! BLOCK the SPEARS!' },
    spells: [
      { id: 'gerson_barrage', name: 'Upper Barrage', tp: 42, dmg: 40, dur: 300, kind: 'attack',
        text: 'GERSON rains SPEARS from above!' },
      { id: 'gerson_spearsweep', name: 'Spear Sweep', tp: 46, dmg: 42, dur: 340, kind: 'attack',
        text: 'GERSON sweeps SPEARS in a circle!' },
      { id: 'gerson_shellvolley', name: 'Shell Volley', tp: 44, dmg: 42, dur: 360, kind: 'attack',
        text: 'GREEN SOUL! BLOCK the SHELLS!' },
      { id: 'gerson_shellkick', name: 'Shell Kick', tp: 44, dmg: 48, dur: 300, kind: 'attack',
        text: 'GERSON kicks a SHELL!' },
      { id: 'gerson_swingdown', name: 'Swing Down', tp: 48, dmg: 52, dur: 320, kind: 'attack',
        text: 'GERSON telegraphs a SLASH!' },
      { id: 'gerson_boxthrow', name: 'Box Throw', tp: 46, dmg: 46, dur: 403, kind: 'attack',
        text: 'GERSON lobs HAMMERS into the box!' },
      { id: 'gerson_squish', name: 'Squish Barrage', tp: 48, dmg: 46, dur: 460, kind: 'attack',
        text: 'GERSON SQUISHES the box — dodge the DIAMONDS!' },
      { id: 'gerson_rudebuster', name: 'Rude Buster', tp: 44, dmg: 50, dur: 300, kind: 'attack',
        text: 'GERSON fires RUDE BUSTER! Press [Z] to knock it back!' },
    ],
    ult: { id: 'gerson_finale', name: 'Trial of the Holy Hammer', tp: 100, dmg: 58, dur: 460, kind: 'attack',
