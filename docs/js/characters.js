...
const CHARS = {
  ...
  gerson: {
    ...
    fight: { id: 'gerson_spears', name: 'Spear Volley', dmg: 18, dur: 300,
             text: 'GREEN SOUL! BLOCK the SPEARS!' },
    spells: [
      { id: 'gerson_barrage', name: 'Upper Barrage', tp: 42, dmg: 20, dur: 300, kind: 'attack',
        text: 'GERSON rains SPEARS from above!' },
      { id: 'gerson_spearsweep', name: 'Spear Sweep', tp: 46, dmg: 20, dur: 340, kind: 'attack',
        text: 'GERSON sweeps SPEARS in a circle!' },
      { id: 'gerson_shellvolley', name: 'Shell Volley', tp: 44, dmg: 22, dur: 360, kind: 'attack',
        text: 'GREEN SOUL! BLOCK the SHELLS!' },
      { id: 'gerson_shellkick', name: 'Shell Kick', tp: 44, dmg: 34, dur: 300, kind: 'attack',
        text: 'GERSON kicks a SHELL!' },
      { id: 'gerson_swingdown', name: 'Swing Down', tp: 48, dmg: 40, dur: 320, kind: 'attack',
        text: 'GERSON telegraphs a SLASH!' },
      { id: 'gerson_boxthrow', name: 'Box Throw', tp: 46, dmg: 28, dur: 403, kind: 'attack',
        text: 'GERSON lobs HAMMERS into the box!' },
      { id: 'gerson_squish', name: 'Squish Rain', tp: 48, dmg: 26, dur: 460, kind: 'attack',
        text: 'GERSON SQUISHES the box and rains hammers!' },
      { id: 'gerson_rudebuster', name: 'Rude Buster', tp: 44, dmg: 44, dur: 300, kind: 'attack',
